...
class MobileToolsScreen extends StatelessWidget {
  const MobileToolsScreen({Key? key}) : super(key: key);
      ...
      builder: (context,state){
        ...
        return Scaffold(
          body: ConditionalBuilder(
            ...
            builder: (context) => ProductGridBuilder(cubit.toolModel! , context),
